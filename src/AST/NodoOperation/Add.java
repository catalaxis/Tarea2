...
public class Add implements NodeType{
    private NodeType nodeTypeLeft;
    private NodeType nodeTypeRight;
    public Add(NodeType Left, NodeType Right){ //Constructor de la clase
    ...
    @Override
    public Add get(){
        return new Add(this.nodeTypeLeft, this.nodeTypeRight);
    }
